...
export function EblazeSphere() {
  ...
  return (
    <div className='relative flex items-center justify-center text-[0.16rem] text-center border rounded-full aspect-square p-[0.9rem] clip-circle'>
      <div ref={scene} style={{ width: '100%', height: '100%' }} id='sphere-real' />
      <div className='absolute top-1/2 left-1/2 w-max h-auto text-xs -translate-x-1/2 -translate-y-1/2 font-semibold'>Eblaze</div>
    </div>
  );
}
